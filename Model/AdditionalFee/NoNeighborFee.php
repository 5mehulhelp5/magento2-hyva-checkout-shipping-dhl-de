...
class NoNeighborFee implements AdditionalFeeProviderInterface
{
    ...
    public function getFee(Quote $quote): float
    {
        ...
        foreach ($selections as $selection) {
            // Prüft, ob die Option "No Neighbor Delivery" aktiviert ist
            if ($selection->getShippingOptionCode() === Codes::SERVICE_OPTION_NO_NEIGHBOR_DELIVERY && (bool)$selection->getInputValue()) {
                // Holt den Gebührenwert aus der Konfiguration
                $feeConfigPath = 'carriers/dhlpaket/service_no_neighbor_delivery_charge';
