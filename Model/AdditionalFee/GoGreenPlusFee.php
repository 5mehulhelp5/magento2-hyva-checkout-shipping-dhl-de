...
class GoGreenPlusFee implements AdditionalFeeProviderInterface
{
    ...
    public function getFee(Quote $quote): float
    {
        ...
        foreach ($selections as $selection) {
            if ($selection->getShippingOptionCode() === Codes::SERVICE_OPTION_GOGREEN_PLUS && (bool)$selection->getInputValue()) {
                $feeConfigPath = 'carriers/dhlpaket/service_gogreen_plus_charge';
